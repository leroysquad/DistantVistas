...
| **Runtime** | .NET **10** |
| **Git tip** | `main` @ merge of release/1.0.0 (official 1.0) |
...
| Official | **1.0.0** | Declared stable; current repo tip |

Canonical **play** builds have moved: ModDB still hosts 0.7.x history; **this repo tip is 1.0.0**. Local trees may lag GitHub — always read `modinfo.json` on the branch you have.
...
Max **8 L0 bakes/tick** (`MaxBakePerTick`). View held at **750** blocks (`LodLoginBakeViewBoost`).
