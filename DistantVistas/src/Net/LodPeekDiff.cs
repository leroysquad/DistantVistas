...
///
/// EXPERIMENT A (/dvgen diff) compares a peek against a full generation of the same
...
///
/// EXPERIMENT B (/dvgen edittest) places a marker block, reads it back from the loaded
                ...
                sapi.Event.EnqueueMainThreadTask(() =>
                {
                    ...
                    else
                    {
                        logger.Warning(
                            ...
                            + "trusting /dvgen anywhere near edited terrain.");
                    }
