## 0.7.16
- **Fixes I needed after living with Vintage Horizons far terrain.** Full detail stays on when you back away instead of turning into giant blocky slabs. Incomplete captures stay hidden instead of drawing shelves or skinny pillars. Old grass/soil colours refresh so brown bands do not crawl toward you. Still includes join-download and white-cliff work from 0.7.15, plus colour / winter / fog seam work from 0.7.12-0.7.14. Personal fork shared in case it helps. Not taking credit for Horizons or anyone else. What works for me may not work for you.
