...
- **Verify:** `finished` climbs past **358**; `paintReadyQueued>0`; `chunkPressure:true` when starved; `captureStall` ≪ `residentPaint`/`painted`; warm-ring-probe shows pending shifts to loaded/resident keys.
