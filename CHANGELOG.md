## 0.7.16
- **Fixes I needed after living with Vintage Horizons far terrain.** Keeping full detail at range so backing away does not turn mountains into giant blocky slabs. Hiding incomplete captures so partial data does not draw as shelves or skinny pillars. Refreshing old grass/soil colours so brown bands do not crawl toward you. Still includes the join-download and white-cliff work from 0.7.15, and the colour / winter / fog seam work from 0.7.12–0.7.14. This is a personal fork shared in case it helps; what works here may not on your setup.
